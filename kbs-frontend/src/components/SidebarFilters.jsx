...
import posterKashmir from "../assets/poster_kashmir.webp";
import posterTriangle from "../assets/poster_triangle.webp";
import posterGoa from "../assets/poster_goa.webp";
import posterLadakh from "../assets/poster_ladakh.webp";
import posterHimachal from "../assets/poster_himachal.webp";
        ...
        <div className="filter-section">
          <SidebarOfferCard
            offers={[
              ...
              {
                bgImage: posterLadakh
              },
              {
                bgImage: posterHimachal
              }
            ]}
            onCta={onGetQuote}
          />
          <SidebarOfferCard
            offers={[
              {
                bgImage: posterKashmir
              },
              {
                bgImage: posterTriangle
              }
            ]}
            onCta={onGetQuote}
          />
